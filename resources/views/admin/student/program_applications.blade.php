                ...
                <tbody>
                    ...
                    @foreach ($programs as $prog)
                        <tr class="border-bottom">
                            ...
                            @if ($campus_id != null)
                                <td class="border-left border-right">{{ \App\Models\ApplicationForm::where('program_first_choice', $prog->id)->where('year_id', \App\helpers\Helpers::instance()->getCurrentAccademicYear())->whereNotNull('transaction_id')->where('campus_id', $campus_id)->count() }}</td>
                            @else
                                <td class="border-left border-right">{{ \App\Models\ApplicationForm::where('program_first_choice', $prog->id)->where('year_id', \App\helpers\Helpers::instance()->getCurrentAccademicYear())->whereNotNull('transaction_id')->count() }}</td>
                            @endif
